...
#line 1 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
#include <stdlib.h>
#include <string.h>
#include <stdio.h>
#include <unistd.h>
...
#line 27 "libdnsdist-common.a.p/dnslabeltext.cc"
...
#line 30 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
...
#line 93 "libdnsdist-common.a.p/dnslabeltext.cc"
	{
	cs = dnstext_start;
	}

#line 96 "libdnsdist-common.a.p/dnslabeltext.cc"
	{
	int _klen;
	unsigned int _trans;
	const char *_acts;
...
_match:
	...
	while ( _nacts-- > 0 )
	{
		...
		{
	case 0:
#line 42 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{ 
                        ret.push_back(segment);
                        segment.clear();
                }
	break;
	case 1:
#line 46 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{ 
                        segment.clear();
                }
	break;
	case 2:
#line 50 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{
                  char c = *p;
	...
	break;
	case 3:
#line 54 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{
                  char c = *p;
                  val *= 10;
                  val += c-'0';
	...
	break;
	case 4:
#line 60 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{
	...
	break;
	case 5:
#line 65 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{
                  appendSplit(ret, segment, *(p));
                }
	break;
#line 204 "libdnsdist-common.a.p/dnslabeltext.cc"
		}
	}
...
#line 42 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	...
	break;
#line 225 "libdnsdist-common.a.p/dnslabeltext.cc"
		}
	}
	}
...
#line 78 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
...
#line 243 "libdnsdist-common.a.p/dnslabeltext.cc"
...
#line 94 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
...
#line 311 "libdnsdist-common.a.p/dnslabeltext.cc"
	{
	cs = dnsnameraw_start;
	}

#line 314 "libdnsdist-common.a.p/dnslabeltext.cc"
	{
	int _klen;
	unsigned int _trans;
	const char *_acts;
...
_match:
	...
	while ( _nacts-- > 0 )
	{
		...
		{
	case 0:
#line 114 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{ 
                        if (labellen > 63) {
	...
	break;
	case 1:
#line 121 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{ 
                        lenpos=ret.size();
                        ret.append(1, (char)0);
                        labellen=0;
	...
	break;
	case 2:
#line 127 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{
                  char c = *p;
                  ret.append(1, c);
                  labellen++;
	...
	break;
	case 3:
#line 132 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{
                  char c = *p;
                  val *= 10;
                  val += c-'0';
	...
	break;
	case 4:
#line 137 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{
                  ret.append(1, val);
                  labellen++;
                  val=0;
	...
	break;
	case 5:
#line 143 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{
                  ret.append(1, *(p));
                  labellen++;
                }
	break;
#line 429 "libdnsdist-common.a.p/dnslabeltext.cc"
		}
	}
...
#line 137 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	...
	break;
#line 460 "libdnsdist-common.a.p/dnslabeltext.cc"
		}
	}
	}
...
#line 164 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
...
#line 493 "libdnsdist-common.a.p/dnslabeltext.cc"
...
#line 557 "libdnsdist-common.a.p/dnslabeltext.cc"
	{
	cs = dns_text_to_string_start;
	}

#line 232 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
...
#line 566 "libdnsdist-common.a.p/dnslabeltext.cc"
	{
	int _klen;
	unsigned int _trans;
	const char *_acts;
...
_match:
	...
	while ( _nacts-- > 0 )
	{
		...
		{
	case 0:
#line 194 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{
    escaped_octet *= 10;
    escaped_octet += (*p)-'0';
    counter++;
	...
	break;
	case 1:
#line 200 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{
    val += escaped_octet;
    escaped_octet = 0;
  }
	break;
	case 2:
#line 205 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{
    val += (*p);
    counter++;
  }
	break;
	case 3:
#line 210 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{
    counter++;
  }
	break;
#line 663 "libdnsdist-common.a.p/dnslabeltext.cc"
		}
	}
...
#line 239 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
...
#line 690 "libdnsdist-common.a.p/dnslabeltext.cc"
...
#line 739 "libdnsdist-common.a.p/dnslabeltext.cc"
	{
	cs = dns_text_to_value_list_start;
	}

#line 288 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
...
#line 748 "libdnsdist-common.a.p/dnslabeltext.cc"
	{
	int _klen;
	unsigned int _trans;
	const char *_acts;
...
_match:
	...
	while ( _nacts-- > 0 )
	{
		...
		{
	case 0:
#line 259 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{
    tmp += (*p);
    counter++;
  }
	break;
	case 1:
#line 264 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{
    tmp += (*p);
  }
	break;
	case 2:
#line 268 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{
    val.push_back(tmp);
    tmp.clear();
    counter++;
	...
	break;
	case 3:
#line 274 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	{
    counter++;
  }
	break;
#line 844 "libdnsdist-common.a.p/dnslabeltext.cc"
		}
	}
...
#line 268 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
	...
	break;
#line 866 "libdnsdist-common.a.p/dnslabeltext.cc"
		}
	}
	}
...
#line 295 "../../dnsdist/pdns/dnsdistdist/./dnslabeltext.rl"
